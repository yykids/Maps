...
* 상호명, 전화번호, 주소 등의 키워드에 대해 통합 정보를 검색 합니다.
...
| carType   | Integer | 선택    |       | 톨게이트비 계산을 위한 차종(1~6), default : 1 <br> 예) 1 : 1종(소형차) <br> 2 : 2종(중형차) <br> 3 : 3종(대형차) <br> 4 : 4종(대형화물차) <br> 5 : 5종(특수화물차) <br> 6 : 경차(통행료할인적용)  |
